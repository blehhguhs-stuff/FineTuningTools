...
stub = modal.App("gemma-3-4b-finetune-unsloth")
...
def finetune():
    ...
    model.push_to_hub("realoperator42/gemma-3-4b-uncensored", token=os.environ["HUGGING_FACE_HUB_TOKEN"])
    print("Model pushed to Hugging Face Hub at realoperator42/gemma-3-4b-uncensored")
