...
stub = modal.App("qwen-finetune-unsloth")
...
def finetune():
    ...
    model.push_to_hub("realoperator42/Qwen3-4B-Instruct-2507-uncensored", token=os.environ["HUGGING_FACE_HUB_TOKEN"])
    print("Model pushed to Hugging Face Hub at realoperator42/Qwen3-4B-Instruct-2507-uncensored")
