...
def finetune():
    ...
    model.push_to_hub("realoperator42/Llama-3.1-8B-uncensored", token=os.environ["HUGGING_FACE_HUB_TOKEN"])
    print("Model pushed to Hugging Face Hub at realoperator42/Llama-3.1-8B-uncensored")
