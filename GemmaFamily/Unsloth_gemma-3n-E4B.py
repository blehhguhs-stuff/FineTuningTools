...
stub = modal.App("gemma-finetune-unsloth")
...
def finetune():
    ...
    model.push_to_hub("realoperator42/gemma-3n-E4B-uncensored", token=os.environ["HUGGING_FACE_HUB_TOKEN"])
    print("Model pushed to Hugging Face Hub at realoperator42/gemma-3n-E4B-uncensored")
