...
def convert_to_gguf():
    ...
    model, tokenizer = FastLanguageModel.from_pretrained(
        model_name="realoperator42/Qwen3-4B-Thinking-2507-uncensored",
        max_seq_length=2048,
        dtype=None,
        load_in_4bit=True,
    )
    ...
    api.upload_file(
        ...
        path_in_repo="Qwen3-4B-Thinking-2507-uncensored-Q4_K_M.gguf",
        repo_id=repo_id,
        repo_type="model",
    )
    print("Model converted and pushed to Hugging Face Hub at realoperator42/Qwen3-4B-Thinking-2507-uncensored-GGUF")
