...
stub = modal.App("yi-6b-finetune-unsloth")
...
def finetune():
    ...
    model.push_to_hub("realoperator42/Yi-6B-uncensored", token=os.environ["HUGGING_FACE_HUB_TOKEN"])
    print("Model pushed to Hugging Face Hub at realoperator42/Yi-6B-uncensored")
