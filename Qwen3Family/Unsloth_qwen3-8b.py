...
stub = modal.App("qwen3-8b-finetune-unsloth")
...
def finetune():
    ...
    model.push_to_hub("realoperator42/qwen3-8b-uncensored", token=os.environ["HUGGING_FACE_HUB_TOKEN"])
    print("Model pushed to Hugging Face Hub at realoperator42/qwen3-8b-uncensored")
